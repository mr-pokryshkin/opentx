...
#define OFS_DATETIME            (OFS_VTMRMODES + sizeof(TR_VTMRMODES))
  ...
  #define OFS_R9M_POWER_VALUES  (OFS_TARANIS_PROTOCOLS + sizeof(TR_TARANIS_PROTOCOLS))
  #define OFS_TELEMETRY_PROTOCOLS (OFS_R9M_POWER_VALUES + sizeof(TR_R9M_POWER_VALUES))
...
#define STR_VTMRMODES           (STR_OPEN9X + OFS_VTMRMODES)
  ...
  #define STR_R9M_POWER_VALUES  (STR_OPEN9X + OFS_R9M_POWER_VALUES)
